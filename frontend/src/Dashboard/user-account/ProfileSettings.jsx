...
import { BASE_URL } from "../../config.js"; //backend url
import { toast } from "react-toastify";
import HashRouter from "react-spinners/HashLoader";
      ...
      <form onSubmit={submitHandler}>
        ...
        <div className="mb-5 flex items-center gap-3">
          ...
          <div className="relative w-[130px] h-[50px]">
            ...
            >
              {selectedFile ? "Reupload Photo" : "Upload Photo"}
            </label>
          </div>
        </div>
        <div className="mt-7">
          <button
            ...
            type="submit"
            className="w-full bg-primaryColor text-white text-[17px] font-semibold leading-[25px] rounded-lg  px-3 py-2 border border-b-slate-700"
          >
            {loading ? (
              <HashRouter size={35} color="#fffffff" />
            ) : (
              "Update Profile"
            )}
          </button>
